...
class FiltermsWindow(Toplevel):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self._rbWhitelist = ttk.Radiobutton(
            _mainframe,
            text="whitelist",
            variable=self._listTypeVar,
            value="wl",
            command=self._refresh,
        )
        self._rbBlacklist = ttk.Radiobutton(
            _mainframe,
            text="blacklist",
            variable=self._listTypeVar,
            value="bl",
        ...
        self._cbArrayOnly = ttk.Checkbutton(
            _mainframe,
            text="show value only",
            variable=self._arrayOnlyON,
            command=self._refresh,
        )
        ...
        self._bToFile = ttk.Button(
            _mainframe, text="send to file", command=self._onToFile
        )
        self._bToClip = ttk.Button(
            _mainframe, text="send to clipboard", command=self._onToClip
        )
        ...
        self._wTextDisplay.grid(
            column=0, row=2, sticky="news", columnspan=3, pady=10, padx=10
        )
