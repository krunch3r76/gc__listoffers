...
class SpyuModel:
    ...
    def _connect(self):
        ...
        if not self._connected:
            try:
                self._con = sqlite3.connect(dbpath_as_uri
    ...
    def _copy_to_memory(self):
        ...
        try:
            ...
            pass
        self._memcon=sqlite3.connect(":memory:", detect_type=sqlite3.PARSE_DECLTYPE
                , isolation_level=None)
    ...
    def lookup_model(self, addr):
        ...
        if self._connected:
            ...
            modelname == ''
            ss = "SELECT modelname, MAX(unixtime) FROM provider" \
